...
public class CustomerServiceImpl implements CustomerService{
	...
	public String register(UserDto userDto, BindingResult result ) {
		...
		if(adminRepository.existsByEmail(userDto.getEmail())||adminRepository.existsByEmail(userDto.getEmail())||merchantRepository.existsByEmail(userDto.getEmail()))
			result.rejectValue("email", "error.email","Email is already Exists");
		if(result.hasErrors()) {
			return "customer-register.html";
		}
		return "redirect:/";
